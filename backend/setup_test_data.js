...
async function clearAndCreateData() {
  try {
    ...
    await RegionalOfficer.deleteMany({ username: { $in: ['rajesh.kumar', 'rajesh.kumar2'] } });
    await Hospital.deleteMany({ hospitalId: { $regex: 'HOSP-KA-BLR' } });
    await HospitalAdmin.deleteMany({ adminId: { $regex: 'ADMIN-HOSP-KA-BLR' } });
    await HospitalDoctor.deleteMany({ doctorId: { $regex: 'DOC-HOSP-KA-BLR' } });
    await HospitalAssistant.deleteMany({ assistantId: { $regex: 'ASST-HOSP-KA-BLR' } });
    console.log('✅ Cleared existing test data\n');

    // Step 1: Create a Regional Officer with unique username
    console.log('👨‍💼 Creating Regional Officer...');
    const regionalOfficer = new RegionalOfficer({
      username: 'rajesh.kumar2',
      password: '$2b$10$hash123456',
      firstName: 'Rajesh',
      lastName: 'Kumar',
      fullName: 'Dr. Rajesh Kumar',
      aadhaarNumber: '123456789013', // Unique aadhaar
      email: 'rajesh.kumar2@health.gov.in', // Unique email
      phone: '9876543211', // Unique phone
      dateOfBirth: new Date('1975-05-15'),
      gender: 'male',
      officerRank: 'regional_director',
      employeeId: 'EMP-RO-2024-002', // Unique employee ID
      ...
      officePhone: '080-22251001', // Unique office phone
      ...
      yearsOfService: 15,
      appointmentDate: new Date('2010-01-15'),
      isActive: true
    });
    ...
    const hospital = new Hospital({
      hospitalId: 'HOSP-KA-BLR-002', // Unique hospital ID
      ...
      licenses: [
        {
          ...
          number: 'HL-KA-2024-002', // Unique license number
    ...
    const hospitalAdmin = new HospitalAdmin({
      adminId: 'ADMIN-HOSP-KA-BLR-002-001',
      hospitalId: hospital.hospitalId,
      username: 'priya.admin2', // Unique username
      password: '$2b$10$hash123456',
      adminName: 'Priya Sharma',
      email: 'priya.sharma2@apollohospitals.com', // Unique email
      contactNumber: '9876543212', // Unique contact
      isActive: true
    });
    ...
    const hospitalDoctor = new HospitalDoctor({
      doctorId: 'DOC-HOSP-KA-BLR-002-001',
      hospitalId: hospital.hospitalId,
      username: 'arun.doctor2', // Unique username
      password: '$2b$10$hash123456',
      doctorName: 'Dr. Arun Patel',
      specialization: 'Cardiology',
      email: 'arun.patel2@apollohospitals.com', // Unique email
      contactNumber: '9876543213', // Unique contact
      qualification: {
        degree: 'MBBS, MD Cardiology'
      },
      registrationNumber: 'KMC67891', // Unique registration number
    ...
    const hospitalAssistant = new HospitalAssistant({
      assistantId: 'ASST-HOSP-KA-BLR-002-001',
      hospitalId: hospital.hospitalId,
      username: 'sunita.assistant2', // Unique username
      password: '$2b$10$hash123456',
      assistantName: 'Sunita Rao',
      email: 'sunita.rao2@apollohospitals.com', // Unique email
      contactNumber: '9876543214', // Unique contact
      qualification: {
        degree: 'B.Sc Nursing'
      },
